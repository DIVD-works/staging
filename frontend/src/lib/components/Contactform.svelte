...
<form method="post" action="https://formspree.io/f/mpqyqzvr" onsubmit={
    ...
    <fieldset class="border-2 border-purple-500 rounded-2xl grid grid-cols-12 w-full gap-3 font-medium text-base sm:text-lg 
        ...
        <div class="form_div md:col-span-6!">
            <input id="first_name" type="text" class="input_default mb-2" placeholder="Enter your First Name" 
                aria-describedby="full_name first_name" name="firstname" bind:value={form.firstname.field} 
                onblur={(): boolean => form.firstname.noerror = true} required minlength="2" maxlength="100"
            />
        ...
        <div class="form_div md:col-span-6!">
            <input id="last_name" type="text" class="input_default mb-2" placeholder="Enter your Last Name" 
                aria-describedby="full_name last_name" name="lastname" bind:value={form.lastname.field} 
                onblur={(): boolean => form.lastname.noerror = true} required minlength="2" maxlength="100"
            />
        ...
        <input id="company" type="text" class="input_default col-span-12 caret-black! dark:caret-white!" 
            placeholder="Enter your Company" name="company" bind:value={form.company.field} 
        ...
        <input id="job_title" type="text" class="input_default col-span-12 caret-black! dark:caret-white!" 
            placeholder="Enter your Job Title" name="jobtitle" bind:value={form.jobtitle.field} onblur={(): boolean => 
        ...
        <div class="form_div">
            <input id="email_address" type="email" class="input_default col-span-12 mb-2" 
                placeholder="Enter your E-mail Address" name="email" bind:value={form.emailaddress.field} 
                onblur={(): boolean => form.emailaddress.noerror = true} required minlength="6" maxlength="250"
            />
        ...
        <div class="form_div">
            <input id="phone_number" type="tel" class="input_default col-span-12 caret-black! dark:caret-white!" 
                placeholder="Enter your Phone Number" name="phonenumber" bind:value={form.phonenumber.field} 
        ...
        <textarea id="your_message" class="input_default h-48! col-span-12 py-3" placeholder="Enter your Message" 
            name="yourmessage" bind:value={form.yourmessage.field} onblur={(): boolean => form.yourmessage.noerror = true}
        ...
        <div class="form_div flex-row!">
            <input id="agreement" type="checkbox" class="border border-black dark:border-white w-8 h-8 rounded-md 
                text-purple-500" name="agreement" bind:checked={form.agreement.field} 
                onblur={(): boolean => form.agreement.noerror = true} required
            />
        ...
        <span class="hidden col-span-12">
            Should be Empty: 
            <input type="text" class="input_default col-span-12 caret-black! dark:caret-white!" name="emptyfield" 
